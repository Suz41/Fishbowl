...
public final class JellyfinSettingsActivity extends AppCompatActivity {
    @Override public void onCreate(Bundle state) {
        ...
        SharedPreferences prefs = getSharedPreferences("jellyfindroid", MODE_PRIVATE); Switch auto = new Switch(this); auto.setText("Auto-start Jellyfin"); auto.setChecked(prefs.getBoolean("auto_start", true)); auto.setOnCheckedChangeListener((v, checked) -> prefs.edit().putBoolean("auto_start", checked).apply()); root.addView(auto);
