...
We take the security of **JellyfinDroid** seriously. This document outlines our security policies, supported versions, and how to report vulnerabilities.
...
If you discover a security vulnerability in JellyfinDroid, please do **not** open a public issue. Instead, report it privately to ensure we can publish a fix before public disclosure:
...
JellyfinDroid adheres to strict local-only execution and sandboxing models:
